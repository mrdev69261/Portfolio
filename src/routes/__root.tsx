...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Devender Kumar builds scalable MERN web applications with AI-first experiences. Senior-quality engineering, premium product design." },
      { name: "theme-color", content: "#1a1a1a" },
      { property: "og:title", content: "Devender Kumar — MERN Full Stack Developer" },
      { property: "og:description", content: "Scalable web applications with AI-first experiences." },
